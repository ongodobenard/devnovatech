...
// ONE main button (SMS icon, green with pulse) → click reveals WhatsApp + Call
function FloatingContact() {
  ...
  return (
    <>
      ...
      {/* Sub-buttons — WhatsApp + Call — revealed on click */}
      ...
      {/* ONE main FAB — green SMS icon, pulse ring when closed, X when open */}
      <button
